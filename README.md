...
The objective of this work is to extend the **Jaya algorithm** into a mixed-type hyperparameter optimization engine suitable for modern machine learning workflows.
...
- Deterministic improvement toward best-performing individuals
- Successfully handled normalized continuous search spaces
...
This repository represents an initial working prototype toward building a production-ready, mixed-type Jaya-based hyperparameter optimization engine designed for integration into the R ecosystem.
